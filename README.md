...
Este addon para Blender permite gerar mapas de profundidade (Depth Maps) mais precisos ao renderizar cenas com vidro. Ele calcula a profundidade de cada pixel, levando em conta a refração, reflexão e IOR dos materiais de vidro.
...
Mapa de profundidade fake feito a partir de dois mapas com e sem o material de vidro
...
⚙️ Instalação
Para usar o addon, você precisará carregar o script principal:

    Baixe o arquivo zGlass.py

    No Blender, vá para a aba Scripting.

    Clique em Open e selecione o arquivo zGlass.py.
...
O objetivo principal é criar uma interface de usuário que elimine a necessidade de configurar propriedades personalizadas manualmente, dessa forma será possivel configurar o addon de forma rápida e intuitiva.
